...
struct BorderFix : public cocos2d::CCLayerColor {
    struct Padding {
        float top;
        float right;
        float bottom;
    ...
    static BorderFix* create(cocos2d::CCNode* node, const cocos2d::ccColor4B& backgroundColor, const cocos2d::CCSize& size = { 0, 0 }, const cocos2d::CCPoint& padding = { 0, 0 });
...
protected:
    ...
    BorderFix(const cocos2d::CCPoint& padding = { 0, 0 });
